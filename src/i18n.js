...
const resources = {
  en: {
    translation: {
      ...
      "cover-letter": "Join thousands of Brands and Influencers who elevated their social media growth with Exo Booster, the most trusted social media boosting service with over 100,000 users.",
  ...
  fr: {
    translation: {
      ...
      "cover-letter": "Rejoignez des milliers de marques et d'influenceurs qui ont augmenté leur croissance sur les médias sociaux avec Exo Booster, le service de stimulation des médias sociaux le plus fiable avec plus de 100 000 utilisateurs.",
...
const lng = (window.localStorage.getItem("language")
  || navigator.language || navigator.userLanguage).slice(0, 2) || "en";
